"object" == typeof navigator && function(e, t) {
    ...
    class it {
        constructor(e) {
            t(this, "load", (() => {
                ...
                const {
                    src: t
                } = this.player.config.posterThumbnails;
                ...
                this.elements.thumb.container = O("div", {
                    class: this.player.config.classNames.posterThumbnails.thumbContainer
                }), this.elements.thumb.imageContainer = O("div", {
                    class: this.player.config.classNames.posterThumbnails.imageContainer
                }), this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
                const e = O("div", {
                    class: this.player.config.classNames.posterThumbnails.timeContainer
                });
                this.elements.thumb.time = O("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.imageContainer.appendChild(e), A.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = O("div", {
                    class: this.player.config.classNames.posterThumbnails.scrubbingContainer
    ...
    class nt {
        ...
        setposterThumbnails(e) {
            this.posterThumbnails && this.posterThumbnails.loaded && (this.posterThumbnails.destroy(), this.posterThumbnails = null), Object.assign(this.config.posterThumbnails, e), this.config.posterThumbnails.enabled && (this.posterThumbnails = new it(this))
        }
